    ...
    <>
      ...
      <div className="composer-foot">
        <div className="composer-hint">
          <code>$...$</code> inline · <code>$$...$$</code> display · <code>**bold**</code> · <code>## heading</code>
        </div>
        <div className="composer-actions">
          <button className="btn btn-outline" onClick={onClose}>Cancel</button>
          <button className="btn btn-primary" onClick={onSave} disabled={!draft.title.trim()}>Publish</button>
        </div>
      </div>
    </>
  );
