...
// the Web Speech API TTS on flashcard flip) lives here too since the
// Settings modal owns both toggles.
...
export function JapaneseI18nProvider({ children }) {
  ...
  const [silentMode, setSilentMode] = useState(() => {
    try { return localStorage.getItem(SILENT_MODE_KEY) === '1'; } catch (e) { return false; }
  });
