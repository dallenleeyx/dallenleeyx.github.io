...
// proof, updatedAt, deleted? } } }. Each item is its own independent
// last-write-wins record, merged by id. Deletes are tombstones (deleted:
// true) rather than removing the key outright, so an older copy of the
// item arriving from another device during a merge can't resurrect
