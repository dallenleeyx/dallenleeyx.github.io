// lib/bible/books.js — static list of the 66 canonical books, grouped by
// testament, with their chapter counts (used to render each book's chapter
// grid without needing any external Bible data/API).
...
export const BIBLE_BOOKS_BY_ID = Object.fromEntries(BIBLE_BOOKS.map((b) => [b.id, b]));
