...
import { getWeekSchedule, startOfWeek, isoDate, DAY_NAMES } from '../../lib/schedule';
    ...
    <section>
      ...
      {courses.length ? (
        <div className="fade-up d1">
          <WeekGrid weekStart={weekStart} items={items} onEmptySlot={openCreate} onEventClick={openView} />
        </div>
      ) : (
