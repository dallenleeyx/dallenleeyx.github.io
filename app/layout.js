    ...
    <html lang="en" data-theme="light" data-scroll-behavior="smooth">
      <head>
        ...
        {/* Every section's fonts loaded upfront as real <link> tags (not a CSS
            ...
            /japanese, /fitness, /math, and /bible never waits on a fresh
            font fetch. Math uses STIX Two Text (headings/body) + DM Mono
            (code). Bible uses Cormorant Garamond for headings (a classic
            literary display serif) and Lora for body/verse text (a warm,
            highly readable book serif) -- deliberately distinct from
